...
def plot_training_curves(log_df, figures_dir):
    ...
    plt.ylabel("Loss")
    plt.title("Minimal RL v2 - Training Loss Curves")
    plt.grid(True)
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(figures_dir, "minimal_rl_v2_loss_curves.png"), dpi=300)
    plt.close()
    ...
    plt.xlabel("Iteration")
    plt.ylabel("Rate")
    plt.title("Minimal RL v2 - Evaluation Metrics")
    plt.grid(True)
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(figures_dir, "minimal_rl_v2_eval_curves.png"), dpi=300)
    plt.close()
    ...
    plt.xlabel("Iteration")
    plt.ylabel("Return")
    plt.title("Minimal RL v2 - Evaluation Average Return")
    plt.grid(True)
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(figures_dir, "minimal_rl_v2_return_curve.png"), dpi=300)
    plt.close()
...
def save_checkpoint(checkpoint_dir, iteration, actor, critic, actor_optimizer, critic_optimizer, config):
    ...
    checkpoint_path = os.path.join(checkpoint_dir, f"minimal_rl_v2_iter_{iteration}.pt")
...
def main():
    ...
    log_csv_path = os.path.join(logs_dir, "minimal_rl_v2_train_log.csv")
